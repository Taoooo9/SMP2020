from DataProcessing.Vocab import *
import numpy as np
import torch
...
def data_iter(data, batch_size, shuffle=True):
    """
    randomly permute DataProcessing, then sort by source length, and partition into batches
...
def batch_data_variable(batch, vocab, eval=False):
    ...
    return [words, extwords, lengths, masks]
